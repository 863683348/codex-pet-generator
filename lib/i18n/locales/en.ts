...
export const en = {
  ...
  hero: {
    ...
    titleHighlight: '— Free AI Pet Maker',
    subtitle:
      'Turn any photo into a custom Codex pet. Free, fast, no sign-up — create pixel-art cats, dogs, and fantasy pets in minutes, then download your installable spritesheet + pet.json.',
    uploading: 'Uploading…',
