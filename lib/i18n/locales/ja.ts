...
export const ja: Dict = {
  ...
  nav: { github: 'GitHub', home: 'ホームへ', blog: 'ブログ', collections: 'Collections', leaderboard: 'Leaderboard', submit: 'Submit', signIn: 'ログイン', signOut: 'ログアウト', myPets: 'マイペット', gallery: 'ギャラリー', spec: 'スペック', guide: 'ガイド' },
  footer: { madeWith: 'Codexユーザーのために', compatible: 'OpenAI Codex対応', copyright: '© 2026 PetGen', privacy: 'プライバシーポリシー', terms: '利用規約', faq: 'よくある質問', contact: 'お問い合わせ' },
    ...
    starter: { name: 'スターター', price: '無料', period: '永久', desc: 'PetGenを試してみましょう。', cta: '始める', f1: '1回のペット生成', f2: '9種類のアニメーション', f3: '標準画質スプライト', f4: 'WebPダウンロード', f5: 'コミュニティサポート' },
  ...
  faq: {
    ...
    q10: '無料プランはありますか？', a10: 'はい。スタータープランは無料で1回の生成を提供します。'},
  trust: {
  ...
  privacy: {
    ...
    s1title: '1. 収集する情報', s1items: ['アカウント情報 — Googleログイン時、名前、メールアドレス、プロフィール画像を受け取ります。', 'アップロード画像 — 生成処理のために一時的に保存されます。', '利用データ — Google Analyticsで匿名化された利用データを収集します。', 'Cookie — 認証と分析のためにCookieを使用します。'],
    s2title: '2. 情報の利用方法', s2items: ['PetGenの提供、維持、改善', 'アップロード画像からのペット生成', 'アカウント認証とサブスクリプション管理', '利用パターンの分析による製品改善', 'サポートリクエストへの対応'],
    s3title: '3. データ共有', s3items: ['Supabase — アカウント管理とファイル保存', 'Vercel — ホスティングとデプロイ', 'Google Analytics — ウェブサイト分析', 'OpenAI / 百煉 — AI画像生成'],
